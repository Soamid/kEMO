 ...
 */
public class StandardAlgorithmsWithInjectedPopulation extends AlgorithmProvider {

    private InjectedInitialization initialization;

    /**
     * Constructs the standard algorithm provider.
     */
    public StandardAlgorithmsWithInjectedPopulation(InjectedInitialization injectedInitialization) {
        this.initialization = injectedInitialization;
    }
